...
rDownloadURL = {"main": "https://balkantv.info/toxic/main_xtreamcodes_reborn.tar.gz?dl=0", "sub": "https://balkantv.info/sub/sub_xtreamcodes_reborn.tar.gz?dl=0"}
